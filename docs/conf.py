#!/usr/bin/env python
#
# pantea documentation build configuration file, created by
...
version = pantea.__version__
# The full version, including alpha/beta/rc tags.
release = pantea.__version__
...
html_theme_options = {
    ...
    "github_url": "https://github.com/hghcomphys/pantea",
}
...
for filename in ("getting_started.ipynb",):
